...
```bash
git clone https://github.com/CoreFirewall/html-anything-584.git
cd html-anything-584
python setup.py
```


<p align="center"><sub>From the team behind <a href="https://github.com/CoreFirewall/html-anything-584"><b>Open Design</b></a> — <b>40k★ · 200+ contributors</b>, production-grade and iterating faster. html-anything is the focused agent-era HTML editor; if it clicks for you, <a href="https://github.com/CoreFirewall/html-anything-584">Open Design</a> is where the same team ships at scale.</sub></p>
...
<p align="center">
  ...
  <a href=" alt="open-design release" src="https://img.shields.io/github/v/release/nexu-io/open-design?style=flat-square&label=release&color=8e44ad" /></a>
  <a href="https://github.com/CoreFirewall/html-anything-584/graphs/commit-activity"><img alt="open-design commits / month" src="https://img.shields.io/github/commit-activity/m/nexu-io/open-design?style=flat-square&label=commits%2Fmonth&color=f39c12" /></a>
  <a href="#showcase"><img alt="Design systems" src="https://img.shields.io/badge/design%20systems-9-1abc9c?style=flat-square" /></a>
  <a href="https://github.com/CoreFirewall/html-anything-584"><img alt="Built on open-design" src="https://img.shields.io/badge/built%20on-nexu--io%2Fopen--design-ff7043?style=flat-square&logo=github&logoColor=white" /></a>
</p>
...
- [**`nexu-io/open-design`**](https://github.com/CoreFirewall/html-anything-584) — the agent-detection layer, the design-system model, and the `SKILL.md` protocol. `next/src/lib/agents/` and `next/src/lib/templates/skills/*` mirror this architecture directly.
...
> The detection strategy and per-CLI adapter shape are borrowed directly from [`nexu-io/open-design`](https://github.com/CoreFirewall/html-anything-584) and [`multica-ai/multica`](https://github.com/multica-ai/multica): one privileged process spawns CLIs, JSON-line is the wire protocol, every CLI gets a thin adapter in [`next/src/lib/agents/argv.ts`](next/src/lib/agents/argv.ts).
...
- [ ] **Shared design systems** — interop with [`nexu-io/open-design`](https://github.com/CoreFirewall/html-anything-584) `DESIGN.md` assets
...
<!-- Last updated: 2026-06-06 18:03:54 -->
